...
(function () {
    ...
    async function fetchDateRange(collection, start, end) {
        ...
        const rows = [];
        snap.forEach(doc => rows.push({ id: doc.id, _source: collection, ...doc.data() }));
        return rows;
    }
                    ...
                    <div class="grid-3">
                        ...
                        <div class="form-group">
                            ...
                            <div style="display:flex;gap:8px;flex-wrap:wrap;">
                                <button class="btn btn-secondary btn-auto" onclick="rptv2_setRange('today')">Today</button>
                                <button class="btn btn-secondary btn-auto" onclick="rptv2_setRange('week')">Week</button>
                                <button class="btn btn-secondary btn-auto" onclick="rptv2_setRange('month')">Month</button>
                            </div>
                        </div>
                    </div>
